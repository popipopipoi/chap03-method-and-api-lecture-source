...
public class Application3 {
    ...
    public static void main(String[] args) {
        /* 스캐너 사용 시 주의사항에 대해 이해하고 고려하여 사용할 수 있다. */
        ...
        * 숫자로 변경하지 못해서 InputMismatchException 이 발생할 수 있는 기능성이 있다.
        * => 공백이 있는 문자열을 입력 받아야 할 경우에는 next가 아닌 nextLine 사용하기 */
        ...
        System.out.println("str2 : " + str2); //ㅀ

        /* 입력 버퍼에 남아있는 개행문자로 인해 nextLine()이 아무 값도 입력 받지 않고 빈 문자열로 처리 된다.
